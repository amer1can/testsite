    ...
    <div class="container">
        <form @submit.prevent="submit_form()" v-if="!commentSuccess">
            <div class="mb-3">
                ...
                <div class="alert alert-warning" v-if="errorsMessage.subject">
            ...
            <div class="mb-3">
                ...
                <div class="alert alert-warning" v-if="errorsMessage.body">
        ...
        <div v-for="comment in comments" class="toast-container pb-2 mt-5 mx-auto" style="min-width: 90%;">
